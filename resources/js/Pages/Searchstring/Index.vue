            ...
            <div class="flex flex-col md:flex-row sm:space-y-4 md:space-y-0 md:space-x-4 pl-3 pr-3">
                        ...
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                            <div class="p-6 bg-white border-b border-gray-200">
                                <div class="flex flex-col">
                                    <h3 class="font-semibold text-xl pb-4">Nieuwe Zoekopdracht</h3>
                                    <div class="space-y-4">
                                        <div class="">
                ...
                <div class="w-full md:w-1/2 mx-auto sm:px-6 lg:px-0 sm:py-6 lg:py-0">
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 bg-white border-b border-gray-200">
                            <div class="flex flex-col">
                                <h3 class="font-semibold text-xl pb-4">Actieve Zoekopdrachten</h3>
                                <div class="space-y-4">
                                    <ul>
                                        <li v-for="searchstring in searchstrings" :key="searchstring.id">
                                            <Link :href="route('searchstring.edit', searchstring.id)">
                                                {{ searchstring.name }}
                                            </Link>
                                        </li>
                                    </ul>
